        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DetailedDescription = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportCustomers", x => new { x.BanReportId, x.CustomerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    NewTotalPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    MoneyToReturn = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: true),
                    PaymentMethodId = table.Column<int>(type: "int", nullable: false),
                    CustomerId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnPurchaseOrders_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReturnPurchaseOrders_PaymentMethods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReturnProducts", x => new { x.ProductId, x.PurchaseOrderId });
                    table.ForeignKey(
                        ...
                        principalColumns: new[] { "ProductId", "PurchaseOrderId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReturnProducts_ReturnPurchaseOrders_ReturnOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnPurchaseOrders_CustomerId",
                table: "ReturnPurchaseOrders",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnPurchaseOrders_Name",
                table: "ReturnPurchaseOrders",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReturnPurchaseOrders_PaymentMethodId",
                table: "ReturnPurchaseOrders",
                column: "PaymentMethodId");
        }
